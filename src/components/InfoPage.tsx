...
function InfoViewComponent() {
  return (
    <div className="bycs-mfe__info-hero-container">
      <div className="bycs-mfe__info-hero-content">
        <div className="bycs-mfe__info-hero-text">
          <h1>
            <span className="bycs-mfe__hero-highlight">Datenquelle & Hintergrund</span>
          </h1>
          
          <section className="bycs-mfe__info-section">
            <p className="bycs-mfe__info-text">
            ...
            <div className="bycs-mfe__info-features">
              <div className="bycs-mfe__info-feature">
        ...
        <div className="bycs-mfe__info-hero-image">
