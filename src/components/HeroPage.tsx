...
function HeroViewComponent() {
  return (
    <div className="bycs-mfe__hero-container">
      <div className="bycs-mfe__hero-content">
        <div className="bycs-mfe__hero-text">
          <p className="bycs-mfe__eyebrow">Bayerns Schulen in Zahlen</p>
          <h1>
            <span className="bycs-mfe__hero-highlight">Klassenwiederholungen in Bayern</span>
          </h1>
          <p>
          ...
          <div className="bycs-mfe__hero-features">
            <div className="bycs-mfe__feature">
        ...
        <div className="bycs-mfe__hero-image">
